...
채용공고는 provider별로 최대 15개씩 후보를 가져오고, 회사명이 같은 공고는 중복으로 보고 하나만 남깁니다. Node.js/NestJS 명시 공고를 우선 수집하고, 30개를 채우지 못하면 조건이 조금 미달되더라도 백엔드/서버 개발 포지션으로 남은 개수를 보충합니다. 그래도 30개 미만이면 있는 것만 Slack으로 보냅니다.
